...
class Adm_voucher extends Resources\Controller
{
	...
	public function index($page=1)
    {
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_voucher/index/%#%/',
			'total' => $total_voucher,	
		    'current' => $page,
			)
					)->getUrl(); 
	...
	public function penerima_voucher($page=1){
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_voucher/penerima_voucher/%#%/',
	...
	public function cari_penerima(){
		...
		if($_POST){
			...
			$this->redirect('adm_voucher/penerima_voucher');
		}
	...
	public function input_penerima($page=1){
		...
		<p>Silahkan cek halaman <a href="'.$this->uri->baseUri.'index.php/adm_voucher">Data Voucher</a> Apakah masih ada voucher yang perlu di input data penerima voucher?</p>
