...
class Adm_registrasi extends Resources\Controller
{
	...
	public function index($page=1)
    {
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_registrasi/index/%#%/',
	...
	public function edit_registrasi(){
		...
		$data['alert']='
			...
			<a href="'.$this->uri->baseUri.'index.php/adm_registrasi/" type="button" class="btn btn-primary btn-lg btn-block">Data Registrasi</a>
			';
		...
		$this->output('admin/index', $data);
			...
			$data['alert']='
				...
				<a href="'.$this->uri->baseUri.'index.php/adm_home" type="button" class="btn btn-primary btn-lg btn-block">Back to Home</a>
				';
