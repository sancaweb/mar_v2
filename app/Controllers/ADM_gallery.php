...
class ADM_gallery extends Resources\Controller
{
	...
	public function index($page=1)
    {
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_gallery/index/%#%/',
	...
	public function view($kategori='',$page=1)
    {
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_gallery/view/'.$kategori2.'/%#%/',
			'total' => $total_gallery,	
		    'current' => $page,
			)
					)->getUrl(); 
	...
	public function input_gallery($page=1)
    {
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_gallery/index/view/'.$kategori_id.'%#%/',
			'total' => $total_gallery,	
		    'current' => $page,
			)
					)->getUrl(); 
