...
class ADM_pesan extends Resources\Controller
{
	...
	public function index($page=1){
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_pesan/index/%#%/',
			'total' => $total_pesan,	
		    'current' => $page,
			)
					)->getUrl(); 
	...
	public function sentitems($page=1){
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_pesan/sentitems/%#%/',
	...
	public function kirim_pesan()
    {
        ...
        if($_POST){
			...
			array(
				'limit' => $limit,
				'base' => $this->uri->baseUri.'index.php/admin_pesan/sentitems/%#%/',
				'total' => $total_pesan_sentitems,	
				'current' => $page,
				)
						)->getUrl(); 
