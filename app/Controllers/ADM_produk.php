...
class Adm_produk extends Resources\Controller
{
	...
	public function index($page=1)
    {
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_produk/index/%#%/',
			'total' => $total_produk,	
		    'current' => $page,
			)
					)->getUrl(); 
	...
	public function kategori($page=1)
    {
		...
		array(
		    'limit' => $limit,
		    'base' => $this->uri->baseUri.'index.php/adm_produk/kategori/index/%#%/',
