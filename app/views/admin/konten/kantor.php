				  ...
				  <div class="modal-dialog " role="document">
					<div class="modal-content">
					  <div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Alert Hapus Data Kantor</h4>
					  </div>
                    ...
                    <p>Apakah anda yakin ingin menghapus data <strong><?php echo $data->nama_kantor;?></strong> ?</p>
					  ...
					  <div class="modal-footer">					
						<a href="<?php echo $this->uri->baseUri;?>index.php/adm_about/hapus_kantor/<?php echo base64_encode($data->id);?>" type="button" class="btn btn-danger">Hapus</a>	
				...
				<div class="modal fade bs-example-modal-lg" id="myModalview<?php echo $data->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				  <div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
					  <div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="myModalLabel">View Data Kantor <?php echo $data->nama_kantor;?></h4>
					  </div>
					  <div class="modal-body">
						<!--FORM View-->
				...
				<div class="modal fade bs-example-modal-lg" id="myModal<?php echo $data->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				  <div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
					  ...
					  <div class="modal-body">
						<!--FORM Edit-->
						<form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_about/edit_kantor">
						<div class="row" style="border-bottom:2px solid #B8B8B8; border-top:2px solid #B8B8B8; margin-bottom:10px;border-bottom-right-radius: 15em 1em; border-bottom-left-radius: 1em 3em;border-top-left-radius: 1em 3em; border-top-right-radius: 1em 3em;">
						<input type="hidden" name="id" value="<?php echo $data->id;?>">
						<div class="col-md-6">					
						<div class="form-group">
						...
						<div class="form-group">
						  <label>No.tlp:</label>
						  <div class="input-group col-xs-12" >
						  <input class="form-control" name="tlp" type="text" id="telpon_edit" value="<?php echo $data->tlp;?>" minlength="5" data-validation-minlength-message="Isikan data yang benar, minimal 5 karakter" required >
