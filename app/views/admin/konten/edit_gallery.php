				...
				<div class="modal fade bs-example-modal-lg" id="myModaleditkat<?php echo $viewall_kategori_by_id->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				  <div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
					  ...
					  <form id="form_kategori" data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_gallery/pro_edit_kat/<?php echo base64_encode($viewall_kategori_by_id->id);?>">
					...
					<div class="modal fade" id="myModalconfirm<?php echo $gallery->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					  <div class="modal-dialog " role="document">
						...
						<img class="img-responsive" src="<?php echo $this->uri->baseUri;?>upload/gallery/thumbs/<?php echo $gallery->foto;?>">
						  ...
						  <div class="modal-footer">					
							<a href="<?php echo $this->uri->baseUri;?>index.php/adm_gallery/hapus_gallery/<?php echo base64_encode($gallery->id).'/'.base64_encode($gallery->kategori);?>" type="button" class="btn btn-danger">Hapus</a>	
				...
				<div class="modal fade bs-example-modal-lg" id="myModaledit<?php echo $gallery->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				  <div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
					  ...
					  <div class="modal-body">
					  <form id="form_kategori" data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_gallery/pro_edit_gallery/<?php echo base64_encode($gallery->kategori);?>">
