				...
				<?php if($penerima_voucher){
					...
					<div class="modal fade" id="myModalactivate<?php echo $data->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					  <div class="modal-dialog " role="document">
						...
						<form method="post" action="<?php echo $this->uri->baseUri;?>index.php/adm_voucher/activate">
				  ...
				  <div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
					  ...
					  <div class="alert alert-danger alert-dismissable">
						...
						<form id="form_produk" data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_voucher/edit_penerima">
