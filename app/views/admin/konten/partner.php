					  ...
					  <div class="modal-dialog " role="document">
						...
						<img class="img-responsive" src="<?php echo $this->uri->baseUri;?>upload/partner/<?php echo $partner->image;?>">
						  ...
						  <div class="modal-footer">					
							<a href="<?php echo $this->uri->baseUri;?>index.php/adm_pengaturan/hapus_partner/<?php echo base64_encode($partner->id);?>" type="button" class="btn btn-danger">Hapus</a>	
				...
				<div class="modal fade bs-example-modal-lg" id="myModaledit<?php echo $partner->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				  <div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
					  ...
					  <div class="modal-body">
					  <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_pengaturan/edit_partner">
