...
<?php $this->output('admin/form/input_kategori_kabar');?>
			  ...
			  <a class="btn btn-app" data-toggle="modal" data-target="#myModal<?php echo $data->id;?>">
				...
				<div class="modal fade" id="myModalconfirm<?php echo $data->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				  <div class="modal-dialog " role="document">
                    ...
                    <h4>Menghapus data <?php echo $data->nama_kategori;?></h4>
                    <p>Apakah anda yakin ingin menghapus data <strong><?php echo $data->nama_kategori;?></strong> ?</p>
                  </div>					  
					  <div class="modal-footer">					
						<a href="<?php echo $this->uri->baseUri;?>index.php/adm_produk/hapus_kategori/<?php echo base64_encode($data->id);?>" type="button" class="btn btn-danger">Hapus</a>	
				...
				<div class="modal fade bs-example-modal-lg" id="myModal<?php echo $data->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				  <div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
					  ...
					  <div class="modal-body">
						<!--FORM Edit-->
						<form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_kabar/pro_edit_kategori">
						...
						<div class="form-group">
						  ...
						  <input name="nama_kategori" type="text" class="form-control" value="<?php echo $data->nama_kategori;?>" required>
						  </div>
						</div>				  
						</div>
