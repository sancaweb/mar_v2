...
<div class="box-header with-border">
  ...
  <div class="box-tools pull-right">
	<a class="btn btn-danger btn-xs" href="<?php echo $this->uri->baseUri;?>index.php/adm_pesan/view_pesan/<?php echo base64_encode($id_pesan).'/'.base64_encode($data_balas_pesan->id);?>">
		<i class="fa fa-refresh" aria-hidden="true"></i> &nbsp; Reload Message	 
	</a>
  <a href="<?php echo $this->uri->baseUri;?>index.php/adm_pesan" type="button" class="btn btn-primary btn-flat btn-xs">
	  <i class="fa fa-envelope-o" aria-hidden="true"></i>
	  &nbsp;View Inbox</a>
	  <a href="<?php echo $this->uri->baseUri;?>index.php/adm_pesan/sentitems" type="button" class="btn btn-primary btn-flat btn-xs">
  ...
  <div class="direct-chat-contacts">
	...
	<?php if($loader_pesan){
		foreach($loader_pesan as $loader_pesan){
			...
			?>
			<li>
				<a href="<?php echo $this->uri->baseUri;?>index.php/adm_esan/view_pesan/<?php echo base64_encode($loader_pesan->id_pesan).'/'.base64_encode($loader_pesan->id);?>">
...
<div class="box-footer">
  <form id="form_penerima_voucher" data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_pesan/balas_pesan">
