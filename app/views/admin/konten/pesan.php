	  ...
	  <div class="box">
		...
		<!-- Nav tabs -->
		  <ul class="nav nav-tabs" role="tablist">
			<li role="presentation" <?php if($page=='inbox'){echo 'class="active"';}?>><a href="<?php echo $this->uri->baseUri;?>index.php/adm_pesan" >Inbox</a></li>
			<li role="presentation" <?php if($page=='sentitems'){echo 'class="active"';}?>><a href="<?php echo $this->uri->baseUri;?>index.php/adm_pesan/sentitems" >Sent Items</a></li>
		  </ul>
				...
				<tr>
				  ...
				  <th >Action</th>
					...
					?>
						...
						?></td>	
						<td>
						<a class="btn btn-app" href="<?php echo $this->uri->baseUri;?>index.php/adm_pesan/view_pesan/<?php echo base64_encode($data->id_pesan).'/'.base64_encode($data->id);?>">
				...
				<tr>
				  ...
				  <th >Action</th>
					...
					?>
						...
						?></td>	
						<td>
						<a class="btn btn-app" href="<?php echo $this->uri->baseUri;?>index.php/adm_pesan/view_pesan/<?php echo base64_encode($data_sentitems->id_pesan).'/'.base64_encode($data_sentitems->id);?>">
							<i class="fa fa-folder-open"></i> View
							</a>
