	...
	<div class="modal-content">
	  ...
	  <div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="new_kat">
			<form id="form_kategori" data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_gallery/input_gallery">
