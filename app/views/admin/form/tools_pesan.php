  ...
  <div class="modal-dialog " role="document">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		  <form id="form_pesan" data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_pesan/kirim_pesan">
...
<div class="modal fade" id="myModalExcel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog " role="document">
	<div class="modal-content">
	  ...
	  <div class="row" >
		<div class="col-md-6">
		<a class="btn btn-app btn-flat" href="<?php echo $this->uri->baseUri;?>index.php/adm_excel/pesan/<?php echo $page;?>">
		...
		<form class="form-inline" method="post" data-toggle="validator" enctype="multipart/form-data" role="form" action="<?php echo $this->uri->baseUri;?>index.php/adm_excel/pesan">
