...
<div class="modal fade bs-example-modal-lg" id="myModalinputkategori" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form id="form_kategori" data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/adm_produk/pro_input_kategori">
		...
		<div class="col-md-6">					
			<div class="form-group">
			  ...
			  <input name="nama_kategori" type="text" class="form-control" value="" required>
			  </div>
			</div>				  
			</div>
